...
/** Bridge - Bridge from level 3*/

public class Bridge extends StaticBody {
    ...
    private static final BodyImage movingPlatform = new BodyImage("data/LaunchBase/Bridge.png", 4);

    public Bridge(World world) {
    ...
    public boolean getCheckWeighted() {return checkWeighted;}

    public void setCheckWeighted(boolean checkWeighted) {this.checkWeighted = checkWeighted;}
